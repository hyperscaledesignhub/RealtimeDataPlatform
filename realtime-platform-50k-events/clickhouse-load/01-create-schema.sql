...
(
    -- Device identifiers
    device_id String,           -- (100,000 devices)
    device_type String,         -- (20 types)
    customer_id String,         -- (10,000 customers)
    site_id String,             -- (1,000 sites)
    ...
    -- Status and alerts (Enum8 for better type safety)
