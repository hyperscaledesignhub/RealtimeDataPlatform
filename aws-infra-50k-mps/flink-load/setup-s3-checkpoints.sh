...
DEFAULT_CLUSTER_NAME="bench-low-infra"
...
1. Update checkpoint directories in flinkConfiguration:
   ...
   state.checkpoints.dir: s3://${S3_BUCKET}/flink-checkpoints/low-infra/
   state.savepoints.dir: s3://${S3_BUCKET}/flink-savepoints/low-infra/
...
echo "  aws s3 ls s3://${S3_BUCKET}/flink-checkpoints/low-infra/"
echo ""
