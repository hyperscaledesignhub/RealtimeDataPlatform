...
output "ecr_repository_url" {
  ...
  value       = var.create_ecr_repository ? aws_ecr_repository.flink_job[0].repository_url : null
}

output "ecr_repository_arn" {
  description = "ARN of the ECR repository"
  value       = var.create_ecr_repository ? aws_ecr_repository.flink_job[0].arn : null
}
